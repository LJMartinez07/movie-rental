...
export class MovieImagesTable1604633019444 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "movie_likes"(
    ...
    await queryRunner.query(`CREATE TABLE "movie_logs"(
      "id" int NOT NULL AUTO_INCREMENT,
      ...
      "updated_at" datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
      PRIMARY KEY("id"),
      KEY "FK_c63bd816b1348ce6e6e3fd0f139"("movie_id"),
      CONSTRAINT "FK_c63bd816b1348ce6e6e3fd0f139" FOREIGN KEY("movie_id") REFERENCES "movie"("id")
    )`)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "movie_likes" DROP CONSTRAINT "FK_3bc8eda4c33e53316619d61d7d4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "movie_likes" DROP CONSTRAINT "FK_e1cbf8ff3b2c6b4102b5938d417"`,
    );
    await queryRunner.query(
      `ALTER TABLE "movie_logs" DROP CONSTRAINT "FK_c63bd816b1348ce6e6e3fd0f139"`,
    );
    queryRunner.query(`DROP TABLE movie_images`);
    await queryRunner.query(`DROP TABLE "movie_likes"`);
